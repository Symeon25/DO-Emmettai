...
PG_DB = os.getenv("PG_DATABASE", "defaultdb")
...
PG_CONN_STR="postgresql://doadmin:AVNS_y-18CdRh05UXrX-Z7ib@emmett-green-gis-do-user-16508034-0.c.db.ondigitalocean.com:25060/defaultdb?sslmode=require"
# ---------------- Config ----------------
...
vectorstore = PGVector(
    ...
    use_jsonb=True,
    create_extension=False,  # keep False if you created pgvector yourself
)
...
def chat(message, history, session_id: str | None = None):
    """
    ...
    # per-session totals (optional, but you already have SESSION_TOTALS)
